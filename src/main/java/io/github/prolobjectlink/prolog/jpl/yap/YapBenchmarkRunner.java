...
public class YapBenchmarkRunner extends AbstractBenchmarkRunner implements BenchmarkRunner {
	...
	public static class ExecutionPlan {
		...
		public void setUp() {
			...
			provider = Prolog.getProvider(YapProlog.class);
...
//                  D is ( P * 100 ) / A.
	...
	public static void main(String[] args) throws RunnerException {
		...
		builder.include(YapBenchmarkRunner.class.getSimpleName());
		Options opt = builder.build();
		Collection<RunResult> run = new Runner(opt).run();
		new YapBenchmarkRunner().output(run);
